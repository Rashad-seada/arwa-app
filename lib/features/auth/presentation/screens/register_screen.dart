...
class _RegisterScreenState extends ConsumerState<RegisterScreen> {
  ...
  Future<void> _register() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      // Navigate to the stepper registration with just the email
      context.push('/register-stepper', extra: email);
    }
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                // Email field (only field remaining)
                InputField(
